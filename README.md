...
-- The objective of this project is to analyze employee data using SQL to identify the key factors contributing to employee attrition,
-- evaluate workforce trends, and generate meaningful business insights. The project involves writing SQL queries to clean,
-- filter, aggregate, and analyze HR data using joins, subqueries, Common Table Expressions (CTEs), window functions, and views.
-- The analysis helps the HR department understand employee demographics, salary distribution, department-wise performance, attendance,
-- training participation, and attrition patterns,enabling data-driven decisions to improve employee retention, workforce planning,
-- and overall organizational performance.

-- Problem Statement

-- Analyze HR employee data using SQL to identify workforce trends, salary distribution, employee attrition, attendance, 
-- and training participation. The goal is to answer key business questions and generate insights that support data-driven 
-- HR decision-making and improve workforce management.
